<div>
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="text-end"><span class="percent">100%</span> Completed | Topic 02 <span
        ...
        <div class="card-body">
            ...
            <form id="workbookform">
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options1" id="option1_1"
                                                wire:model="radio70" value="Healthy" autocomplete="off" disabled >
                                            ...
                                            <input type="radio" class="btn-check" name="options1" id="option2_1"
                                                wire:model="radio70" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options1" id="option3_1"
                                                wire:model="radio70" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options2" id="option1_2"
                                                wire:model="radio71" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options2" id="option2_2"
                                                wire:model="radio71" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options2" id="option3_2"
                                                wire:model="radio71" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options3" id="option1_3"
                                                wire:model="radio72" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options3" id="option2_3"
                                                wire:model="radio72" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options3" id="option3_3"
                                                wire:model="radio72" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options4" id="option1_4"
                                                wire:model="radio73" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options4" id="option2_4"
                                                wire:model="radio73" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options4" id="option3_4"
                                                wire:model="radio73" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options5" id="option1_5"
                                                wire:model="radio74" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options5" id="option2_5"
                                                wire:model="radio74" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options5" id="option3_5"
                                                wire:model="radio74" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options6" id="option1_6"
                                                wire:model="radio75" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options6" id="option2_6"
                                                wire:model="radio75" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options6" id="option3_6"
                                                wire:model="radio75" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options7" id="option1_7"
                                                wire:model="radio76" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options7" id="option2_7"
                                                wire:model="radio76" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options7" id="option3_7"
                                                wire:model="radio76" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options" id="option1_8" a
                                                wire:model="radio77" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options" id="option2_8" a
                                                wire:model="radio77" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options" id="option3_8" a
                                                wire:model="radio77" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options9" id="option1_9"
                                                wire:model="radio78" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options9" id="option2_9"
                                                wire:model="radio78" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options9" id="option3_9"
                                                wire:model="radio78" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options10" id="option1_10"
                                                wire:model="radio79" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options10" id="option2_10"
                                                wire:model="radio79" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options10" id="option3_10"
                                                wire:model="radio79" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options11" id="option1_11"
                                                wire:model="radio80" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options11" id="option2_11"
                                                wire:model="radio80" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options11" id="option3_11"
                                                wire:model="radio80" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options12" id="option1_12"
                                                wire:model="radio81" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options12" id="option2_12"
                                                wire:model="radio81" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options12" id="option3_12"
                                                wire:model="radio81" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options13" id="option1_13"
                                                wire:model="radio82" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options13" id="option2_13"
                                                wire:model="radio82" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options13" id="option3_13"
                                                wire:model="radio82" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options14" id="option1_14"
                                                wire:model="radio83" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options14" id="option2_14"
                                                wire:model="radio83" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options14" id="option3_14"
                                                wire:model="radio83" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options15" id="option1_15"
                                                wire:model="radio84" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options15" id="option2_15"
                                                wire:model="radio84" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options15" id="option3_15"
                                                wire:model="radio84" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options16" id="option1_16"
                                                wire:model="radio85" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options16" id="option2_16"
                                                wire:model="radio85" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options16" id="option3_16"
                                                wire:model="radio85" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options17" id="option1_17"
                                                wire:model="radio86" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options17" id="option2_17"
                                                wire:model="radio86" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options17" id="option3_17"
                                                wire:model="radio86" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options18" id="option1_18"
                                                wire:model="radio87" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options18" id="option2_18"
                                                wire:model="radio87" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options18" id="option3_18"
                                                wire:model="radio87" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options19" id="option1_19"
                                                wire:model="radio88" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options19" id="option2_19"
                                                wire:model="radio88" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options19" id="option3_19"
                                                wire:model="radio88" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options20" id="option1_20"
                                                wire:model="radio89" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options20" id="option2_20"
                                                wire:model="radio89" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options20" id="option3_20"
                                                wire:model="radio89" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options21" id="option1_21"
                                                wire:model="radio90" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options21" id="option2_21"
                                                wire:model="radio90" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options21" id="option3_21"
                                                wire:model="radio90" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options22" id="option1_22"
                                                wire:model="radio91" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options22" id="option2_22"
                                                wire:model="radio91" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options22" id="option3_22"
                                                wire:model="radio91" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options23" id="option1_23"
                                                wire:model="radio92" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options23" id="option2_23"
                                                wire:model="radio92" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options23" id="option3_23"
                                                wire:model="radio92" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options24" id="option1_24"
                                                wire:model="radio93" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options24" id="option2_24"
                                                wire:model="radio93" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options24" id="option3_24"
                                                wire:model="radio93" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options25" id="option1_25"
                                                wire:model="radio94" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options25" id="option2_25"
                                                wire:model="radio94" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options25" id="option3_25"
                                                wire:model="radio94" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options26" id="option1_26"
                                                wire:model="radio95" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options26" id="option2_26"
                                                wire:model="radio95" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options26" id="option3_26"
                                                wire:model="radio95" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options27" id="option1_27"
                                                wire:model="radio96" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options27" id="option2_27"
                                                wire:model="radio96" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options27" id="option3_27"
                                                wire:model="radio96" value="Warning" autocomplete="off" disabled>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="d-flex">
                                            <input type="radio" class="btn-check" name="options28" id="option1_28"
                                                wire:model="radio97" value="Healthy" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options28" id="option2_28"
                                                wire:model="radio97" value="Depends" autocomplete="off" disabled>
                                            ...
                                            <input type="radio" class="btn-check" name="options28" id="option3_28"
                                                wire:model="radio97" value="Warning" autocomplete="off" disabled>
                    ...
                    <div class="content-container m-5">
                        ...
                        <div class="row">
                            ...
                            style="font-size: small;font-weight: 700;">@error('heart120') This field is required. @enderror</span>
                                <div class="form-floating">
                                    <textarea class="form-control" wire:model="heart120" placeholder="Leave a comment here" class="text-center" id="heart120" style="height: 500px; background-position: center; background-image: url('https://www.westmerciawomensaid.org/crm/img/heart1.jpg'); background-repeat: no-repeat; background-size: 500px auto;" readonly></textarea>
                            ...
                            style="font-size: small;font-weight: 700;">@error('heart121') This field is required. @enderror</span>
                                <div class="form-floating">
                                    <textarea class="form-control" wire:model="heart121" placeholder="Leave a comment here" class="text-center" id="heart121" style="height: 500px;  background-position: center; background-image: url('https://www.westmerciawomensaid.org/crm/img/heart2.jpg'); background-repeat: no-repeat; background-size: 500px auto;" readonly></textarea>
                ...
                @if ($currentstep ==10)
                    <div class="step-five">
                        <div class="form-group">
                            ...
                            <p style="text-align: center">Thank you for viewing Topic 02!</p>
                ...
                @if ($currentstep == 10)
                 ...
                 <a href="{{route('admin.serviceuser')}}" class="btn btn-primary btn-sm mt-3 mr-2 float-end">Exit</a>
                    {{-- <button type="button" class="btn btn-primary btn-sm mt-3 mr-2 float-end" wire:click="decreaseStep()" style="margin-right: 5px;">Back</button> --}}
                @endif
            </form>
        </div>
