<div>
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="text-end"><span class="percent">{{!empty($percent)?$percent:'0'}}%</span> Completed | Topic 03
                <span id="topic_no"></span>
            </div>
            <div class="progress my-2" style="height: 10px;">
                <div class="progress-bar" role="progressbar" style="width:{{ $percent }}%" aria-valuenow="01"
    ...
    <div class="card float-none workbook">
        <div class="card-body">
            <form data-persist="garlic" id="workbookform" wire:submit.prevent="submittopic3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        ...
                                        style="height: 500px; background-position: center; background-image: url('https://www.westmerciawomensaid.org/crm/img/men.jpg'); background-repeat: no-repeat; background-size: 500px auto;"></textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control" wire:model="comment146" placeholder="Leave a comment here"
                                        ...
                                        style="height: 500px;  background-position: center; background-image: url('https://www.westmerciawomensaid.org/crm/img/women.jpg'); background-repeat: no-repeat; background-size: 500px auto;"></textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control"
                                        ...
                                        style="height: 250px; background-repeat: no-repeat; background-size: 500px auto;"></textarea>
                ...
                <div class="step-five">
                    <div class="form-group">
                        ...
                        <p style="text-align: center">Thank you for completing Topic 03!</p>
