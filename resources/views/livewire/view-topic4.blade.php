                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here"
                                            ...
                                            wire:model="comment148" readonly></textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-floating">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a comment here"
                                                class="text-center" style="height: 500px;"
                                                wire:model="comment149" readonly></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 offset-md-1">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        wire:model="comment153" id="heart1" style="height: 500px;" readonly></textarea>
                                ...
                                <div class="form-floating  mb-3">
                                    ...
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        wire:model="comment154" id="heart1" style="height: 500px;" readonly></textarea>
                                ...
                                <div class="form-floating  mb-3">
                                    ...
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        wire:model="comment155" id="heart1" style="height: 500px;" readonly></textarea>
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        wire:model="comment156" id="heart1" style="height: 500px;" readonly></textarea>
                    ...
                    <div class="content-container m-5 text-center">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        wire:model="comment157" id="heart1" style="height: 300px;" readonly></textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        wire:model="comment158" id="heart1" style="height: 300px;" readonly></textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        wire:model="comment159" id="heart1" style="height: 300px;" readonly></textarea>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        wire:model="comment160" id="heart1" style="height: 300px;" readonly></textarea>
                        ...
                        <div class="row my-5">
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment161" disabled>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment162" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment163" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                        ...
                        <div class="row my-5">
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment164" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment165" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment166" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                        ...
                        <div class="row my-5">
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment167" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment168" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment169" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                        ...
                        <div class="row my-5">
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment170" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment171" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment172" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                        ...
                        <div class="row my-5">
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment173" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment174" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" aria-label="Default select example"
                                    wire:model="comment175" disabled>
                                    <option value="">Yes or No?</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        wire:model="comment176" id="heart1" style="height: 300px;" readonly></textarea>
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <textarea class="form-control" placeholder="Leave a comment here"
                                    wire:model="comment177" id="heart1" style="height: 300px;" readonly></textarea>
                ...
                @if ($currentstep == 8)
                    <div class="step-five">
                        <div class="form-group">
                            ...
                            <p style="text-align: center">Thank you for viewing Topic 04!</p>
