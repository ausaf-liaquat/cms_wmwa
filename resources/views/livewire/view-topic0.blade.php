<div>
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="text-end"><span class="percent">100%</span> Completed | Introduction <span
                        ...
                        <div class="content-container m-5">
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days1" class="form-control"  id="session_days1" placeholder=""
                                        wire:model="session_days1" readonly>
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days2" class="form-control" id="session_days2" placeholder=""
                                        wire:model="session_days2" readonly>
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days3" wire:model="session_days3" readonly class="form-control" id="session_days3"
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days4" wire:model="session_days4" readonly class="form-control" id="session_days4"
                                        placeholder="" required>
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days5" wire:model="session_days5" readonly class="form-control" id="session_days5"
                                        placeholder="" required>
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days6" wire:model="session_days6" readonly class="form-control" id="session_days6"
                                        placeholder="" required>
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days7" wire:model="session_days7" readonly class="form-control" id="session_days7"
                                        placeholder="" required>
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days8" wire:model="session_days8" readonly class="form-control" id="session_days8"
                                        placeholder="" required>
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days9" wire:model="session_days9" readonly class="form-control" id="session_days9"
                                        placeholder="" required>
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days10" wire:model="session_days10" readonly class="form-control" id="session_days10"
                                        placeholder="" required>
                            ...
                            <div class="question mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" name="session_days11" wire:model="session_days11" readonly class="form-control" id="session_days11"
                                        placeholder="" required>
                            ...
                            <form>
                                <div class="section mb-4">
                                    ...
                                    <label for="customRange2" class="form-label"> I feel safe and I know how to keep myself
                                        safe.</label>
                                    <input type="range" class="form-range" min="0" max="4" id="safety" wire:model="safety" readonly>
                ...
                @if ($currentstep == 5)
                    <div class="step-five">
                        <div class="form-group">
                            ...
                            <p style="text-align: center">Thank you for viewing Topic Introduction!</p>
