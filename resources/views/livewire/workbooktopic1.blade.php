<div>
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="text-end"><span class="percent"></span> Completed | Topic 01 <span
                    id="topic_no"></span></div>
            <div class="progress my-2" style="height: 10px;">
                <div class="progress-bar" role="progressbar" style="width:3%" aria-valuenow="01" aria-valuemin="0"
                ...
                @if ($currentstep==7)
                    <div class="step-five">
                        <div class="form-group">
                            ...
                            <p style="text-align: center">Thank you for completing Topic 01!</p>
