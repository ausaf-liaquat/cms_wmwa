                        ...
                        <div class="account-dropdown__body">
                            ...
                            <div class="account-dropdown__item">
                                <form id="logout-form" action="{{ route('logout') }}" method="post">
                                    @csrf
                                    <a href="{{ route('logout') }}"
                                        onclick="event.preventDefault();this.closest('form').submit();" style="">
    ...
    <div class="menu-sidebar2__content js-scrollbar2">
        <div class="account2">
            ...
            <form id="logout-form" action="{{ route('logout') }}" method="post">
                @csrf
                <a href="{{ route('logout') }}"
                    onclick="event.preventDefault();this.closest('form').submit();" style="color:#fff">
                   Sign out <i class="zmdi zmdi-power"></i>
                </a>
            </form>
