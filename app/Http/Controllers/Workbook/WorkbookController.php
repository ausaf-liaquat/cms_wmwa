...
class WorkbookController extends Controller
{
    public function openWorkbook($id)
    {
        ...
        if ($id == 1) {
            ...
            return view('Workbook.topic_1', compact('topics'));
        } elseif ($id==4) {
            $topics = Topic::where('id', $id)->with('questions')->first();

            return view('Workbook.topic_2', compact('topics'));
        }elseif ($id==6) {
            $topics = Topic::where('id', $id)->with('questions')->first();
            ...
            return view('Workbook.topic_5', compact('topics'));
        } elseif ($id==12) {
            $topics = Topic::where('id', $id)->with('questions')->first();

            return view('Workbook.topic_6', compact('topics'));
        } elseif ($id==13) {
            $topics = Topic::where('id', $id)->with('questions')->first();

            return view('Workbook.topic_7', compact('topics'));
        } elseif ($id==14) {
            $topics = Topic::where('id', $id)->with('questions')->first();

            return view('Workbook.topic_8', compact('topics'));
        } 
