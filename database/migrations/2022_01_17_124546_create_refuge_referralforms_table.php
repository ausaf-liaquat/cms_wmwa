...
class CreateRefugeReferralformsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('refuge_referralforms', function (Blueprint $table) {
            $table->id();
            $table->string('looking_for_refuge')->nullable();
            $table->string('seeking_refuge_from')->nullable();
            $table->string('looking_refuge_to')->nullable();
            ...
            $table->string('client_eligibility')->nullable();
    ...
    {
        Schema::dropIfExists('refuge_referralforms');
    }
}
